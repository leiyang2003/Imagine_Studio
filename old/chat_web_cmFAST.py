...
def chat_endpoint():
    ...
    # When NSFW is OFF, prepend SFW instruction for the model only; log and display use original input
    message_to_model = user_input
    if not nsfw_allowed:
        message_to_model = "[Keep your reply SFW; avoid explicit sexual or adult content.] " + user_input
